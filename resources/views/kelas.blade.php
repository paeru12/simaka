                                ...
                                <form id="JurusanForm" class="need-validation" novalidate>
                                    ...
                                    <div class="modal-body">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" name="nama" placeholder="Jurusan">
                                            <label>Jurusan</label>
                                        </div>
                                    </div>
...
<script>
    $(function() {
        ...
        $('.editBtnJurusan').click(function() {
            let id = $(this).data('id');
            $.get("{{ url('showJurusan') }}/" + id, function(data) {
